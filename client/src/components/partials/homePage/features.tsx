      ...
      <div className="mt-32 max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-2 max-md:max-w-lg mx-auto gap-8">
          ...
          <div className="sm:p-6 p-4 flex bg-white rounded-md border">
            ...
            >
              <path
                d="M512 128c212.08 0 384 171.92 384 384S724.08 896 512 896 128 724.08 128 512s171.92-384 384-384m0-64C264.6 64 64 264.6 64 512s200.6 448 448 448 448-200.6 448-448S759.4 64 512 64z"
                data-original="#000000"
              />
              <path
                d="M461.2 636.1 352 518.9l45.3-45.3 64.3 64.3L627 376.7l45.3 45.3L461.2 636.1z"
                data-original="#000000"
              />
            </svg>
            <div>
